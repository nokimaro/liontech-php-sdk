...
it('creates with minimal config', function (): void {
    $sdk = new LionTechSDK('test_access_token');
...
it('creates with refresh token', function (): void {
    $sdk = new LionTechSDK('test_access_token', 'test_refresh_token');
...
it('creates with custom base URL', function (): void {
    $sdk = new LionTechSDK('test_access_token', baseUrl: 'https://custom.api.com');
